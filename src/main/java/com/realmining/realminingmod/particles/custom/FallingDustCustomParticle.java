package com.realmining.realminingmod.particles.custom;
...
public class FallingDustCustomParticle extends SpriteTexturedParticle {
    private final float rotSpeed;
    private final IAnimatedSprite sprites;

    private FallingDustCustomParticle(ClientWorld p_i232385_1_, double p_i232385_2_, double p_i232385_4_, double p_i232385_6_, float p_i232385_8_, float p_i232385_9_, float p_i232385_10_, IAnimatedSprite p_i232385_11_) {
    ...
    public static class Factory implements IParticleFactory<BlockParticleData> {
        ...
        public Particle createParticle(BlockParticleData p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            ...
            if (!blockstate.isAir() && blockstate.getRenderShape() == BlockRenderType.INVISIBLE) {
                ...
                if (blockstate.getBlock() instanceof IFallingBlock) {
                    i = ((IFallingBlock)blockstate.getBlock()).getDustColor(blockstate, p_199234_2_, blockpos);
                }

                float f = (float)(i >> 16 & 255) / 255.0F;
                float f1 = (float)(i >> 8 & 255) / 255.0F;
                float f2 = (float)(i & 255) / 255.0F;
                return new FallingDustCustomParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, f, f1, f2, this.sprite);
            }
        }
    }
}