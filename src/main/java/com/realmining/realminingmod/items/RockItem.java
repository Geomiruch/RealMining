...
import com.realmining.realminingmod.entity.custom.RockEntity;
...
public class RockItem extends Item {
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        if (!p_77659_1_.isClientSide) {
            RockEntity rockEntity = new RockEntity(p_77659_1_, p_77659_2_);
            rockEntity.setItem(itemstack);
            rockEntity.shootFromRotation(p_77659_2_, p_77659_2_.xRot, p_77659_2_.yRot, 0.0F, 1.5F, 1.0F);
            p_77659_1_.addFreshEntity(rockEntity);
        }
